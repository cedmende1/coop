...
interface MemberApprovalFilterProps {
  searchTerm: string;
...
export const MemberApprovalFilter: React.FC<MemberApprovalFilterProps> = ({
  searchTerm,
  setSearchTerm,
  statusFilter,
  setStatusFilter,
  ...
  return <div className="p-4 border-b border-[rgba(var(--border-color),0.2)] flex flex-col sm:flex-row justify-between gap-3">
      ...
      <div className="relative flex-grow max-w-md">
        ...
        <input type="text" placeholder="Search by name, email or phone..." value={searchTerm} onChange={e => setSearchTerm(e.target.value)} className="w-full pl-9 pr-3 py-2 rounded-md border border-[rgba(var(--border-color),0.3)] 
        ...
        maxWidth: 'calc(100vw - 16px)'
              ...
              <div className="p-2">
                ...
                <div className="space-y-1">
                  ...
                  <StatusOption label="Pending" value="pending" currentValue={statusFilter} onChange={setStatusFilter} />
                  <StatusOption label="Approved" value="approved" currentValue={statusFilter} onChange={setStatusFilter} />
                  <StatusOption label="Rejected" value="rejected" currentValue={statusFilter} onChange={setStatusFilter} />
                </div>
              </div>
            </div>, document.body)}
      </div>
